angular.module('washery.controllers', [])

.controller('AccessesCtrl', function($scope, $ionicConfig) {

})

// APP
.controller('UserCtrl', function($scope, $ionicConfig) {
...
.controller('PlacesCtrl', function($scope, $ionicLoading) {
        console.log('inside');
