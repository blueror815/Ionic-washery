(function() {
  ...
  angular
    ...
    function PushNotificationsService($rootScope, $cordovaPush, WasheryApi, GCM_SENDER_ID){
        ...
        this.register = function() {
                    ...
                    switch(notification.event)
                    {
                        case 'registered':
                            if (notification.regid.length > 0 ) {
                                ...
                                WasheryApi.setDevice("android", notification.regid);
                            }
                            break;
            ...
            if(ionic.Platform.isIOS())
            {
                ...
                $cordovaPush.register(config).then(function(result) {
                    ...
                    WasheryApi.setDevice("ios", result);
                }, function(err) {
